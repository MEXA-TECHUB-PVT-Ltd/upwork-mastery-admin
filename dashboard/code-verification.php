                    ...
                    <div class="card-body">
                        <div class="form-header">
                            ...
                            <div class="heading-auth">
                                <h4 class="text-center mt-5 mb-3">Verification</h4>
                                <p class="text-center mb-5">Enter code that you received on your email</p>
                            </div>
                        </div>
                        <div class="form-body">
                            <form action="backend/user/verify-code.php" method="post">
                                <div class="mb-3">
                                  <input type="number" name="code" class="form-control" placeholder="Email Code" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
